...
# Defining plot square 
par(mfcol= c(2,2), col="black")

# Creating the plot in the first square
...
# Creating the plot in the second square
...
# Creating the plot in the third square
with(data.table.subset, {
  plot(Date.Time,
       Voltage,
       xlab = "datetime",
...
# Creating the plot in the fourth square
with(data.table.subset, {
  plot(Date.Time,
